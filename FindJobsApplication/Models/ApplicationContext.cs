        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<JobService>().HasData(
                 ...
                 new JobService { JobServiceId = 9, ServiceName = "Nổi Bật Tuyển Dụng 1 lần", Description = "Đưa tin tuyển dụng của bạn lên hàng đầu với gói nổi bật một lần. Đảm bảo rằng tin của bạn thu hút mọi ánh nhìn từ ứng viên ngay từ lần đầu tiên.", Price = 15000, AdminId = 1, Duration = 1, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
                 new JobService { JobServiceId = 10, ServiceName = "Nổi Bật Tuyển Dụng 5 lần", Description = "Đăng tin nổi bật trong 5 lần liên tiếp. Một cách hoàn hảo để đảm bảo rằng thông báo tuyển dụng của bạn luôn được chú ý và tiếp cận với nhiều ứng viên hơn.", Price = 69000, AdminId = 1, Duration = 5, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
                 new JobService { JobServiceId = 11, ServiceName = "Nổi Bật Tuyển Dụng 10 lần", Description = "Với gói 10 lần, bạn không chỉ nổi bật mà còn có thể thu hút nhiều ứng viên hơn thông qua những tin tuyển dụng chất lượng cao và được ưu tiên hiển thị.", Price = 129000, AdminId = 1, Duration = 10, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
                 new JobService { JobServiceId = 12, ServiceName = "Nổi Bật Tuyển Dụng 20 lần", Description = "Gói nổi bật 20 lần sẽ mang lại cho bạn lợi thế cạnh tranh. Tăng cường khả năng thu hút ứng viên phù hợp với gói dịch vụ này.", Price = 199000, AdminId = 1, Duration = 20, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
                 new JobService { JobServiceId = 13, ServiceName = "Nổi Bật Tuyển Dụng 100 lần", Description = "Gói nổi bật 100 lần là sự lựa chọn tuyệt vời cho các công ty lớn. Với số lượng đăng tin dồi dào, bạn sẽ có nhiều cơ hội tiếp cận các ứng viên chất lượng.", Price = 499000, AdminId = 1, Duration = 100, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
                 new JobService { JobServiceId = 14, ServiceName = "Nổi Bật Tuyển Dụng theo ngày", Description = "Đảm bảo tin tuyển dụng của bạn luôn nổi bật hàng ngày trong 30 ngày, thu hút sự chú ý liên tục từ các ứng viên tiềm năng.", Price = 150000, AdminId = 1, Duration = 30, jobServiceType = JobServiceType.FeaturePostJob, Image = "https://tuyendung.topcv.vn/bai-viet/wp-content/uploads/2022/06/dang-tin-tuyen-dung-o-dau-2a.jpg" },
