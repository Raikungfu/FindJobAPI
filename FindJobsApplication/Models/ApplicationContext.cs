        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<JobService>().HasData(
                 new JobService { JobServiceId = 1, ServiceName = "Đăng tin tuyển dụng 1 lần", Description = "Cơ hội để bạn đưa tin tuyển dụng của mình đến với hàng triệu ứng viên. Gói này cho phép bạn đăng một tin tuyển dụng duy nhất, thu hút sự chú ý của những ứng viên tiềm năng ngay lập tức.", Price = 9000, AdminId = 1, Duration = 1, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 2, ServiceName = "Đăng tin tuyển dụng 5 lần", Description = "Tối ưu hóa cơ hội tuyển dụng của bạn với gói 5 lần. Đăng tin tuyển dụng liên tiếp để tiếp cận nhiều ứng viên hơn và tăng khả năng tìm thấy ứng viên phù hợp.", Price = 39000, AdminId = 1, Duration = 5, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 3, ServiceName = "Đăng tin tuyển dụng 10 lần", Description = "Với gói 10 lần, bạn có thể thoải mái đăng tin tuyển dụng của mình mà không lo lắng về chi phí. Đây là lựa chọn hoàn hảo cho các doanh nghiệp có nhu cầu tuyển dụng thường xuyên.", Price = 69000, AdminId = 1, Duration = 10, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 4, ServiceName = "Đăng tin tuyển dụng 20 lần", Description = "Mở rộng khả năng tiếp cận ứng viên của bạn với gói đăng tin 20 lần. Gói này không chỉ tiết kiệm mà còn cho phép bạn duy trì sự hiện diện liên tục trên nền tảng tuyển dụng.", Price = 109000, AdminId = 1, Duration = 20, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 5, ServiceName = "Đăng tin tuyển dụng 100 lần", Description = "Gói 100 lần là giải pháp tối ưu cho các doanh nghiệp lớn với nhu cầu tuyển dụng liên tục. Đăng tin không giới hạn giúp bạn dễ dàng thu hút ứng viên hàng đầu.", Price = 399000, AdminId = 1, Duration = 100, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 6, ServiceName = "Đăng tin tuyển dụng theo ngày", Description = "Đăng tin tuyển dụng mỗi ngày trong 30 ngày, đảm bảo rằng tin tuyển dụng của bạn luôn tươi mới và thu hút. Lựa chọn lý tưởng cho những ai muốn duy trì sự chú ý của ứng viên.", Price = 100000, AdminId = 1, Duration = 30, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 7, ServiceName = "Đăng tin tuyển dụng theo tháng", Description = "Gói đăng tin theo tháng giúp bạn dễ dàng quản lý quá trình tuyển dụng của mình. Đăng tin hàng tháng để thu hút ứng viên liên tục và mở rộng mạng lưới của bạn.", Price = 250000, AdminId = 1, Duration = 30, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 8, ServiceName = "Đăng tin tuyển dụng theo năm", Description = "Chọn gói đăng tin theo năm để đảm bảo sự hiện diện lâu dài của bạn trong thị trường tuyển dụng. Đây là lựa chọn tốt nhất cho các doanh nghiệp có nhu cầu tuyển dụng ổn định trong thời gian dài.", Price = 1000000, AdminId = 1, Duration = 365, jobServiceType = JobServiceType.Service },

                 new JobService { JobServiceId = 9, ServiceName = "Nổi Bật Tuyển Dụng 1 lần", Description = "Đưa tin tuyển dụng của bạn lên hàng đầu với gói nổi bật một lần. Đảm bảo rằng tin của bạn thu hút mọi ánh nhìn từ ứng viên ngay từ lần đầu tiên.", Price = 15000, AdminId = 1, Duration = 1, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 10, ServiceName = "Nổi Bật Tuyển Dụng 5 lần", Description = "Đăng tin nổi bật trong 5 lần liên tiếp. Một cách hoàn hảo để đảm bảo rằng thông báo tuyển dụng của bạn luôn được chú ý và tiếp cận với nhiều ứng viên hơn.", Price = 69000, AdminId = 1, Duration = 5, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 11, ServiceName = "Nổi Bật Tuyển Dụng 10 lần", Description = "Với gói 10 lần, bạn không chỉ nổi bật mà còn có thể thu hút nhiều ứng viên hơn thông qua những tin tuyển dụng chất lượng cao và được ưu tiên hiển thị.", Price = 129000, AdminId = 1, Duration = 10, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 12, ServiceName = "Nổi Bật Tuyển Dụng 20 lần", Description = "Gói nổi bật 20 lần sẽ mang lại cho bạn lợi thế cạnh tranh. Tăng cường khả năng thu hút ứng viên phù hợp với gói dịch vụ này.", Price = 199000, AdminId = 1, Duration = 20, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 13, ServiceName = "Nổi Bật Tuyển Dụng 100 lần", Description = "Gói nổi bật 100 lần là sự lựa chọn tuyệt vời cho các công ty lớn. Với số lượng đăng tin dồi dào, bạn sẽ có nhiều cơ hội tiếp cận các ứng viên chất lượng.", Price = 499000, AdminId = 1, Duration = 100, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 14, ServiceName = "Nổi Bật Tuyển Dụng theo ngày", Description = "Đảm bảo tin tuyển dụng của bạn luôn nổi bật hàng ngày trong 30 ngày, thu hút sự chú ý liên tục từ các ứng viên tiềm năng.", Price = 150000, AdminId = 1, Duration = 30, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 15, ServiceName = "Nổi Bật Tuyển Dụng theo tháng", Description = "Gói nổi bật theo tháng giúp bạn duy trì sự hiện diện nổi bật trong suốt thời gian dài, đảm bảo rằng tin tuyển dụng của bạn luôn ở vị trí dễ thấy.", Price = 300000, AdminId = 1, Duration = 30, jobServiceType = JobServiceType.Service },
                 new JobService { JobServiceId = 16, ServiceName = "Nổi Bật Tuyển Dụng theo năm", Description = "Chọn gói nổi bật theo năm để tối đa hóa khả năng tiếp cận ứng viên và giữ cho tin tuyển dụng của bạn luôn nổi bật trong suốt thời gian dài.", Price = 1200000, AdminId = 1, Duration = 365, jobServiceType = JobServiceType.Service }
             );
