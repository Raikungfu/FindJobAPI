...
namespace FindJobsApplication.Migrations
{
    ...
    [Migration("20241017025248_update-job")]
            ...
            modelBuilder.Entity("FindJobsApplication.Models.Hire", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            EmployerId = 1,
                            HireDate = new DateTime(2024, 10, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6352),
                            JobId = 1,
                            Status = "Đã được thuê"
                        },
                        new
                        {
                            ...
                            EmployeeId = 2,
                            EmployerId = 1,
                            HireDate = new DateTime(2024, 10, 7, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6355),
                            JobId = 1,
                            Status = "Đã được thuê"
                        },
                        new
                        {
                            ...
                            EmployeeId = 1,
                            EmployerId = 2,
                            HireDate = new DateTime(2024, 10, 12, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6359),
                            JobId = 2,
                            Status = "Đã được thuê"
                        });
                });
            ...
            modelBuilder.Entity("FindJobsApplication.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 150m,
                            EmployerId = 1,
                            IssueDate = new DateTime(2024, 10, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6382)
                        },
                        new
                        {
                            InvoiceId = 2,
                            Amount = 200m,
                            EmployerId = 2,
                            IssueDate = new DateTime(2024, 10, 12, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6383)
                        });
                });
            ...
            modelBuilder.Entity("FindJobsApplication.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            JobId = 1,
                            DateFrom = new DateTime(2024, 10, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6273),
                            DateTo = new DateTime(2024, 11, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6286),
                        ...
                        {
                            JobId = 2,
                            DateFrom = new DateTime(2024, 10, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6296),
                            DateTo = new DateTime(2024, 12, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6297),
                        ...
                        {
                            JobId = 3,
                            DateFrom = new DateTime(2024, 10, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6299),
                            DateTo = new DateTime(2025, 1, 17, 9, 52, 48, 193, DateTimeKind.Local).AddTicks(6299),
